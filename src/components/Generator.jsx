...
export default function Generator(props) {
  ...
  return (
    ...
    >
        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 border px-4 duration-200 hover:border-blue-600 py-3 rounded-lg border-blue-400" +
      ...
      />
      <div className="bg-slate-950 rounded-lg border border-blue-400 border-solid flex flex-col">
        <button
          onClick={toggleModal}
      ...
      <Button func={updateWorkout} text={"Generate"} />
    </SectionWrapper>
